class Navbar extends HTMLElement {
  ...
  render() {
    ...
    <nav class="flex items-center justify-between flex-wrap bg-gray-900 p-6 sticky top-0 z-10">
      <div class="flex items-center  text-white mr-6 ml-6">
        <i class="fab fa-github fa-2x"></i>
      </div>
      <div class="block lg:hidden mr-6" id="navbar-button">
      ...
      <div class="w-full hidden block flex-grow lg:flex lg:items-center lg:w-auto mx-6 md:mx-0" id="list-menu">
