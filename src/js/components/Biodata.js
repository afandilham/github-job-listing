        ...
        <div class="container mx-auto flex justify-center shadow-lg rounded-sm bg-white p-4 max-w-screen-md relative mt-20">
          ...
          <div class="flex justify-center flex-col mt-24 mb-6">
            ...
            <div class="social-icon text-center flex justify-center items-center flex-wrap pt-4">
              <a href="https://wa.me/081232294925" target="_blank" class="text-gray-200 pl-6"><i class="fab fa-whatsapp bg-gray-800 fa-lg rounded-full p-2"></i></a>
              <a href="https://www.twitter.com/afandilham" target="_blank" class="text-gray-200 pl-6"><i class="fab fa-twitter bg-gray-800 fa-lg rounded-full p-2"></i></a>
              <a href="htpps://www.github.com/afandilham" target="_blank" class="text-gray-200 pl-6"><i class="fab fa-github bg-gray-800 fa-lg rounded-full p-2"></i></a>
              <a href="https://www.instagram.com/afandilham_" target="_blank" class="text-gray-200 pl-6"><i class="fab fa-instagram bg-gray-800 fa-lg rounded-full p-2"></i></a>
              <a href="https://www.facebook.com/beeforeverybody" target="_blank" class="text-gray-200 pl-6"><i class="fab fa-facebook bg-gray-800 fa-lg rounded-full p-2"></i></a>
            </div>
          </div>
        </div>
      </div>
